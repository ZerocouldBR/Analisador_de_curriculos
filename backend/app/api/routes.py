...
from app.api.v1 import health, settings, candidates, linkedin, auth, documents, search, websocket, chat, vectordb, companies, diagnostics, batch_import, database_management
...
api_router.include_router(database_management.router, prefix="/v1")
